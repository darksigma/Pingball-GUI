 ...
 *
 * PingballClient will have a main render thread, and two background threads
...
public class PingballClient {
     ...
     */
    private static void evolveFrame(Board board, BlockingQueue<String> receiveQueue) {
     ...
     */
    private static void mainLoop(Board board, BlockingQueue<String> receiveQueue) {
        while (true) {
            long start = System.nanoTime();
            evolveFrame(board, receiveQueue);
