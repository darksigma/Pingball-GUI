...
public class BoardGrammarCreatorListener extends BoardGrammarBaseListener {
    ...
    private LinkedBlockingQueue<Pair<Ball, Pair<String, Side>>> ballQueue;
     ...
     */
    public String listenerUsername() {
     ...
     * @param queue
     */
    public void setListenerQueue(LinkedBlockingQueue<Pair<Ball, Pair<String, Side>>> queue) {
    ...
    public void exitBoardLine(BoardGrammarParser.BoardLineContext ctx) {
        ...
        Board game = new Board(boardName, this.gravity, this.mu, this.mu2, this.ballQueue);
    ...
    public void exitTriBumperLine(BoardGrammarParser.TriBumperLineContext ctx) {
        ...
        if(!this.gadgetNames.contains(triBmpName)) {
            gameBoard.addTriangularBumper(triBmpName, triBmpX, triBmpY, Orientation.valueOf(triBmpAngle));
    ...
    public void exitRtFlipLine(BoardGrammarParser.RtFlipLineContext ctx) {
        ...
        if(!this.gadgetNames.contains(rtFlipName)) {
            gameBoard.addRightFlipper(rtFlipName, rtFlipX, rtFlipY, Orientation.valueOf(rtFlipAngle));
    ...
    public void exitLftFlipLine(BoardGrammarParser.LftFlipLineContext ctx) {
        ...
        if(!this.gadgetNames.contains(lftFlipName)) {
            gameBoard.addLeftFlipper(lftFlipName, lftFlipX, lftFlipY, Orientation.valueOf(lftFlipAngle));
