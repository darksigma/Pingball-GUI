...
public class BoardGrammarTests {
    ...
    File f1 = new File("boards/sampleBoard1.pb");
    File f2 = new File("boards/sampleBoard2-1.pb");
    File f3 = new File("boards/sampleBoard2-2.pb");
    File f4 = new File("boards/sampleBoard3.pb");
    File f5 = new File("boards/sampleBoard4.pb");
    File f6 = new File("boards/sampleBoard5.pb");
    File f7 = new File("boards/sampleBoard6.pb");
    File f8 = new File("boards/sampleBoard7.pb");
    File f9 = new File("boards/sampleBoard8.pb");

    BoardGrammarCentral bgc = new BoardGrammarCentral();
    LinkedBlockingQueue<Pair<Ball, Pair<String, Side>>> out = new LinkedBlockingQueue<Pair<Ball, Pair<String, Side>>>();
